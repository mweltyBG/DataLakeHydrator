CREATE    PROCEDURE [dbo].[usp_MetadataListSourceSql] (
...
SELECT 
dbo.udf_GenerateSourceSql(@SourceSchemaTable, @FilterColumn, @FilterColumnDataType, @FilterColumnValue, @SelectQuery, @SqlOverrideQuery, @StartDate, @EndDate) AS Query