...
SELECT 
	...
	'ds_'+SDS.SystemType+'_' +IL.IntegrationRuntime + '_' + CASE WHEN SDS.SystemType IN ('AzureSQLDatabase','Azure','AzureSQL','SQLServer') THEN SDS.AuthenticationMethod ELSE SDS.SystemName END as [SourceDataset],
	'ds_'+SDS.SystemType+'_' +IL.IntegrationRuntime + '_' + CASE WHEN TDS.SystemType IN ('AzureSQLDatabase','Azure','AzureSQL','SQLServer') THEN TDS.AuthenticationMethod ELSE TDS.SystemName END as [TargetDataset],
